...
**Последнее обновление:** 2026-07-27 11:42:55 (+03:00)
...
- `DefinitionsCheatSection`  
  Секция диагностики adventure-definitions. В рантайме показывает загруженные single-def/коллекции из `Adventures.DefinitionsManager` (`GlobalSettings`, `Adventures`, `Classes`, `Ancestries`, `Backgrounds`, `PregeneratedCharacters`, `Creatures`, `Feats`, `Items`, `Spells`, `BattleActions`). Если игра не запущена или менеджер не найден — показывает `HelpBox`.
