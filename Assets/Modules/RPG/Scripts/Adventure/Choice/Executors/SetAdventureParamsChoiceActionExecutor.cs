...
{
    public class SetAdventureParamsChoiceActionExecutor : IChoiceActionExecutor
    {
        [Inject] private readonly AdventureStateLogic _stateLogic;

        private readonly ChoiceActionParamsData _params;

        public SetAdventureParamsChoiceActionExecutor(ChoiceActionParamsData actionParams)
        {
        ...
        public void Execute()
        {
            _stateLogic.ProcessAction(new SetAdventureParamsStateAction(_params));
        }
    }
}
