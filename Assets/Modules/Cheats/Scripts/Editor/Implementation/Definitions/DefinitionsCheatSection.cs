...
namespace Modules.Cheats.Scripts.Editor.Implementation.Definitions
{
    public sealed class DefinitionsCheatSection : CheatSectionBase
    {
        ...
        private void DrawAdventuresDefinitionsManager(AdventuresDefinitionsManager definitionsManager)
        {
            ...
            string profileStateSettingsId = definitionsManager.ProfileStateSettings != null
                ? definitionsManager.ProfileStateSettings.Id
                : "—";
            EditorGUILayout.LabelField("ProfileStateSettings: " + profileStateSettingsId);
            ...
            EditorGUI.indentLevel++;
            DrawDefinitionIds(definitionsManager.Creatures);
            EditorGUI.indentLevel--;

            EditorGUILayout.LabelField("Encounters:");
            EditorGUI.indentLevel++;
            DrawDefinitionIds(definitionsManager.Encounters);
            EditorGUI.indentLevel--;
